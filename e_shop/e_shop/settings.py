...
SECRET_KEY = "django-insecure-@l2dmlj1_pig%bte-roy0w7apev!j(uq&m(*lskoaqn^9w1m&c"
...
# Пример, если вы используете Redis
CELERY_BROKER_URL = 'redis://localhost:6379/0'
CELERY_RESULT_BACKEND = 'redis://localhost:6379/0'

# Если нужно, можно добавить и другие настройки
